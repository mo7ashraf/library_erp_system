...
<div class="receipt">
    ...
    <div class="top-info">
        <div class="box">
            ...
            <div class="line">
                <span class="label">فاتورة الشراء</span>
                <span class="value">{{ $return->purchaseInvoice?->invoice_number ?? '-' }}</span>
            </div>
        ...
        <div class="box">
            <h3>بيانات المورد والمخزن</h3>

            <div class="line">
                <span class="label">المورد</span>
                <span class="value">{{ $return->supplier?->name ?? '-' }}</span>
            </div>
            ...
            <div class="line">
                ...
                <span class="value">
                    @switch($return->refund_type)
                        @case('cash') استرداد نقدي @break
                        @case('supplier_balance') خصم من رصيد المورد @break
                        @default -
                    @endswitch
                </span>
            </div>
