...
<head>
    <meta charset="UTF-8">
    <title>إذن تالف / هالك - {{ $document->document_number }}</title>
...
<div class="receipt">
    ...
    <div class="top-info">
        <div class="box">
            ...
            <div class="line">
                ...
                <span class="value">{{ optional($document->document_date)->format('Y-m-d') }}</span>
            </div>

            <div class="line">
                <span class="label">سبب الخروج</span>
                <span class="value">
                    @switch($document->reason_type)
                        @case('damaged') تالف @break
                        @case('lost') مفقود @break
                        @case('expired') منتهي / غير صالح @break
    ...
    <div class="totals">
        <div class="row">
            ...
            <strong>{{ number_format((float) $document->total_quantity, 3) }}</strong>
        </div>

        <div class="row grand">
            <span>إجمالي التكلفة</span>
            <strong>{{ number_format((float) $document->total_cost, 2) }} ج.م</strong>
        </div>
    </div>
