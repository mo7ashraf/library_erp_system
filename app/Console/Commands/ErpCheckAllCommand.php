...
class ErpCheckAllCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $dashboardResult = $this->call('erp:check-dashboard');

        $this->line('==========================================');

        $salesReportResult = $this->call('erp:check-sales-report');
        ...
        $inventoryReportResult = $this->call('erp:check-inventory-report');

        $this->line('==========================================');

        $partyBalanceReportResult = $this->call('erp:check-party-balance-reports');

        $this->line('==========================================');

        $postedDocumentsReportResult = $this->call('erp:check-posted-documents-report');
        ...
        if (
            ...
            || $inventoryReportResult !== self::SUCCESS
            || $partyBalanceReportResult !== self::SUCCESS
            || $postedDocumentsReportResult !== self::SUCCESS
        ) {
