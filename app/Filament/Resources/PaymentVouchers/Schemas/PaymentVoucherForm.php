                ...
                Section::make('بيانات سند الصرف')
                    ...
                    ->schema([
                        ...
                        Select::make('party_type')
                            ...
                            ->default(PaymentVoucher::PARTY_SUPPLIER)
                            ->required()
                            ->live()
                            ->afterStateUpdated(function (Set $set): void {
                        ...
                        Select::make('customer_id')
                            ...
                            ->searchable()
                            ->preload()
                            ->required(fn (Get $get): bool => $get('party_type') === PaymentVoucher::PARTY_CUSTOMER)
                            ->visible(fn (Get $get): bool => $get('party_type') === PaymentVoucher::PARTY_CUSTOMER),
                        ...
                        Select::make('supplier_id')
                            ...
                            ->searchable()
                            ->preload()
                            ->required(fn (Get $get): bool => $get('party_type') === PaymentVoucher::PARTY_SUPPLIER)
                            ->visible(fn (Get $get): bool => $get('party_type') === PaymentVoucher::PARTY_SUPPLIER),

                        TextInput::make('party_name')
                            ->label('اسم الطرف')
                            ->maxLength(255)
                            ->required(fn (Get $get): bool => $get('party_type') === PaymentVoucher::PARTY_OTHER)
                            ->visible(fn (Get $get): bool => $get('party_type') === PaymentVoucher::PARTY_OTHER),
